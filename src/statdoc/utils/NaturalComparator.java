    ...
    public int compareSplit(String s1, String s2) {
        ...
        while (i < s1Parts.length && i < s2Parts.length) {
            ...
            if (s1Parts[i].compareTo(s2Parts[i]) == 0) {
                ...
                } else if (s1Parts[i].charAt(0) >= '0' && s1Parts[i].charAt(0) <= '9' ) {
                    return 1;
                } else if (s2Parts[i].charAt(0) >= '0' && s2Parts[i].charAt(0) <= '9' ) {
                    return -1;
                } else {
                    return s1Parts[i].toLowerCase().compareTo(s2Parts[i].toLowerCase());
                }
            }
        }
