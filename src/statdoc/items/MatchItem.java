...
/**
 * A special Item to match up parts that might not have been
 * resolved, such as variables in script files where it is not
 * yet known whether they reside in a specific data file.
 * 
...
public class MatchItem extends Item {
     ...
     * 
     * @param args the second level filter(s)
